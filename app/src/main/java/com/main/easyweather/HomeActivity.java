        ...
        protected void onPostExecute(List list) {
            ...
            if(list!=null&&list.size()>0){
                if (list.size()>2){
                    ...
                    cityUltravioletrays.setText(advice.substring(0,advice.indexOf("感冒指数")-2));
                    cityGetCold.setText(advice.substring(advice.indexOf("感冒指数"),advice.indexOf("穿衣指数")-2));
                    cityDressing.setText(advice.substring(advice.indexOf("穿衣指数"),advice.indexOf("洗车指数")-2));
                    cityCarWash.setText(advice.substring(advice.indexOf("洗车指数"),advice.indexOf("运动指数")-2));
                    cityExercise.setText(advice.substring(advice.indexOf("运动指数"),advice.indexOf("空气污染指数")-2));
